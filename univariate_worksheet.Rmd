---
title: "Working through Univariate Plots"
author: "Josh Peters"
date: "`r Sys.Date()`"
output:
...
i7 <- i7 + 
  ...
  coord_flip() + 
  theme(
    axis.title.x = element_text(margin = margin(t = 10), size = rel(1.0)),
    axis.title.y = element_text(size = rel(1.0), angle = 0, vjust = 0.5),
